...
void main() {
	...
	gl_FragColor = texture2D(texture_, texCoord1.xy) * scale1;
	gl_FragColor += texture2D(texture_, texCoord1.zw) * scale2;
	gl_FragColor += texture2D(texture_, texCoord2.xy) * scale3;
	gl_FragColor += texture2D(texture_, texCoord2.zw) * scale4;
}
